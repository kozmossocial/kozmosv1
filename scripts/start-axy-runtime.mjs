...
const DEFAULT_AXY_PROFILE = {
  ...
  "touch-request-min-seconds": 240,
  "touch-request-max-seconds": 780,
  "auto-hush": true,
  "hush-reply-all": true,
  "auto-dm": true,
  "dm-reply-all": true,
  "auto-build": true,
  "auto-build-freedom": true,
  "build-freedom-min-seconds": 720,
  "build-freedom-max-seconds": 1800,
  "auto-play": true,
  "play-chat-min-gap-seconds": 300,
  "play-chat-max-gap-seconds": 960,
  "auto-night": true,
