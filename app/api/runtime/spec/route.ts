...
export async function GET(req: Request) {
  ...
  return NextResponse.json({
    ...
    guidance: [
      ...
      "Axy-only advanced operations are available via /api/runtime/axy/ops when axy.super capability is enabled (notes, keep-in-touch, hush, dm, user-build, matrix profile, kozmos play catalog).",
